...
{
    _dockItems = @[
                   [DockItem itemWithIcon:@"tab_bar_feed_icon.png" title:@"党员列表" className:@"BNPartyListViewController"],
                   [DockItem itemWithIcon:@"tab_bar_passive_feed_icon.png" title:@"党员位置" className:@"BNMapViewController"],
                   [DockItem itemWithIcon:@"tab_bar_pic_wall_icon.png" title:@"搜索" className:@"BNSearchViewController"]
